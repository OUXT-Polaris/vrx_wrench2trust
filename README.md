...
[![Build Status](https://github.com/PickNikRobotics/wrench2thrust/actions/workflows/build_and_test.yaml/badge.svg)](https://github.com/PickNikRobotics/wrench2thrust/actions/workflows/build_and_test.yaml)
...
4. Get the repo:
        ...
        cd $COLCON_WS/src
        git clone git@github.com:PickNikRobotics/wrench2thrust.git

5. Download the required repositories and install any dependencies:

        cd $COLCON_WS/src
        vcs import < wrench2thrust/wrench2thrust.repos
...
To make sure you have the latest repos:
      ...
      cd $COLCON_WS/src/wrench2thrust
      git checkout main
...
To test the pacakges in wrench2thrust, use the following command with [colcon](https://colcon.readthedocs.io/en/released/).
